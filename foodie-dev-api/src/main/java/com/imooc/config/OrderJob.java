...
import com.imooc.controller.OrdersController;
...
/**
 * 需要在启动类上添加启动定时任务的注解@EnableScheduling
 *
 */
@Component
public class OrderJob {
    ...
    public void autoCloseOrder() {
        ...
        System.out.println("德玛西亚"+ DateUtil.getCurrentDateString(DateUtil.DATETIME_PATTERN));
    }
}
